...
def alignImages(normed, ID):
    if (ID == '372'):
        rotImage = rotate(normed, -31.6478, True)
        print ("Image " + ID + " Rotated!")
        print ("Image shape:", rotImage.shape)
        return rotImage
    elif (ID == '430'):
        rotImage = rotate(normed, 62.1013, True)
        print ("Image " + ID + " Rotated!")
        print ("Image shape:", rotImage.shape)
        return rotImage
    elif (ID == '344'):
        rotImage = rotate(normed, -40.9472, True)
        print ("Image " + ID + " Rotated!")
        print ("Image shape:", rotImage.shape)
        return rotImage
    elif (ID == '451'):
        rotImage = rotate(normed, 37.6194, True)
        print ("Image " + ID + " Rotated!")
        print ("Image shape:", rotImage.shape)
        return rotImage
...
for i in range(1, len(ID)):
    if (ID[i] != '435' and ID[i] != '387' and ID[i] != '401' and ID[i] != '331' 
        and ID[i] != '379' and ID[i] != '431' and ID[i] != '393' and ID[i] != '484'):
        if (absorber[i] == 'Yes'):
            try:
