...
for i in range(0, len(sfrDens)):
    if (sfrDens[i] != 0):   #If sfr surface density does not = 0
...
"""
CREATE ASCII TABLE FOR SFRDENSABSORB, SFRDENSNOABSORB, SFRABSORB, SFRNOABSORB
REDSHIFT ABSORBERS, REDSHFIT NON ABSORBERS, REDSHIFT QUALITY ABSORBERS AND NON
ABSORBERS. 
"""
