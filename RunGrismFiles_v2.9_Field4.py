...
plt.hist(sfrDensAbsorb, normed=True, histtype='step', label= 'MgII Detection (%i)' %len(sfrDensAbsorb))
plt.hist(sfrDensNoAbsorb, normed=True, histtype='step', label = 'MgII Non-Detection (%i)' %len(sfrDensNoAbsorb))
...
#plt.clf()
#Needs adjustment to binsArray here. Get error for current (0, 2, 10).
plt.hist(SFRAbsorb,  normed=True, histtype='step', label= 'MgII Detection (%i)' % len(SFRAbsorb))
plt.hist(SFRNoAbsorb,  normed=True, histtype='step', label = 'MgII Non-Detection (%i)' % len(SFRNoAbsorb))
