...
#Histogram plot of number of galaxies and their area   
plt.hist(galAreaKpc, bins=54, color='orange')
plt.subplots_adjust(right=1.0)
plt.subplots_adjust(top=1.0)
plt.xlabel("Area of Galaxy (Kpc)")
plt.ylabel("Number of Galaxies")
plt.savefig('Histogram_GalaxyArea')
plt.show()

#Scatter plot galaxy luminosity distance vs. area of galaxies
plt.scatter(galAreaKpc, distance)
plt.xlabel("Area of Galaxy (Kpc)")
plt.ylabel("Luminosity Distance")
plt.savefig('Area_vs_Distance')
plt.show()

#Scatter plot galaxy area in Kpc vs. star formation surface density
plt.scatter(galAreaKpc, sfrDens)
plt.plot(np.unique(galAreaKpc), np.poly1d(np.polyfit(galAreaKpc, sfrDens, 3))(np.unique(galAreaKpc)), c='r')
plt.xlabel("Galaxy Area (Kpc)")
plt.ylabel("Star Formation Surface Density")
plt.savefig('Area_vs_SfrSurfaceDensity')
plt.show()

#Scatter plot galaxy distance in Mpc vs. star formation surface density
plt.scatter(distance, sfrDens)
plt.xlabel("Distance (Mpc)")
plt.ylabel("Star Formation Surface Density")
plt.savefig("Distance_vs_SfrSurfaceDensity")
plt.show()
