...
def stack(fileList):
    ...
    fits.writeto('Field3_Stacked_Image_Mean.fits', meanImage, overwrite=True)
    fits.writeto('Field3_Stacked_Image_Median.fits', medianImage, overwrite=True)
    fits.writeto('Field3_Stacked_Image.fits', imageStack, overwrite=True)
