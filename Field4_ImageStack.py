...
def stack(fileList):
    ...
    fits.writeto('Field4_Stacked_Image_Mean_Normed.fits', meanImage, overwrite=True)
    fits.writeto('Field4_Stacked_Image_Median_Normed.fits', medianImage, overwrite=True)
    fits.writeto('Field4_Stacked_Image_Normed.fits', imageStack, overwrite=True)
